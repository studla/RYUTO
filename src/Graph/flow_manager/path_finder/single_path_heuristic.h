...
#ifndef SINGLE_PATH_HEURISTIC_H
#define	SINGLE_PATH_HEURISTIC_H

#include "path_finder.h"

class single_path_heuristic : public path_finder {
public:
    single_path_heuristic(ListDigraph& wc,
        ListDigraph::Node& s,
        ListDigraph::Node& t,
