...
#ifndef SINGLE_PATH_HEURISTIC_NO_NEIGHBOUR_H
#define	SINGLE_PATH_HEURISTIC_NO_NEIGHBOUR_H

#include "path_finder.h"

class single_path_heuristic_no_neighbour : public path_finder {
public:
    single_path_heuristic_no_neighbour(ListDigraph& wc,
        ListDigraph::Node& s,
        ListDigraph::Node& t,
    ...
    virtual ~single_path_heuristic_no_neighbour();
...
private:
    ...
    unsigned int find_neighbouring(ListDigraph::Arc a);
    
    exon_meta* meta;
};

#endif	/* SINGLE_PATH_HEURISTIC_NO_NEIGHBOUR_H */
