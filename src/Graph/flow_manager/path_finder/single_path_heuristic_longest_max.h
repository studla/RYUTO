...
#ifndef SINGLE_PATH_HEURISTIC_LONGEST_MAX_H
#define	SINGLE_PATH_HEURISTIC_LONGEST_MAX_H

#include "path_finder.h"

class single_path_heuristic_longest_max : public path_finder {
public:
    single_path_heuristic_longest_max(ListDigraph& wc,
        ListDigraph::Node& s,
        ListDigraph::Node& t,
    ...
    virtual ~single_path_heuristic_longest_max();
...
#endif	/* SINGLE_PATH_HEURISTIC_LONGEST_MAX_H */
