...
#ifndef SINGLE_PATH_HEURISTIC_EVIDENCE_PENALTY_H
#define	SINGLE_PATH_HEURISTIC_EVIDENCE_PENALTY_H

#include "path_finder.h"

class single_path_heuristic_evidence_penalty : public path_finder {
public:
    single_path_heuristic_evidence_penalty(ListDigraph& wc,
        ListDigraph::Node& s,
        ListDigraph::Node& t,
    ...
    virtual ~single_path_heuristic_evidence_penalty();
